                ...
                <div className="sidebar">
                  <ul>
                      ...
                      <li><a href="#" class="nav-link px-3">
                          ...
                          <span class="text">Upload Certificate</span>
                        </a></li>
                      <li><a href="#" class="nav-link px-3">
                          <i class="material-icons icon">
                            exit_to_app
                      ...
                      <main role="main" class="col-lg-100">
                          <div id="content"><center>
                              ...
                              <div>
                                  ...
                                  <form name="b">
                                      <div>
                                          Student UID<input type="text" name="cid" className="form-b"/>
                                      </div>
                                      <br/>
                                      <div>
                                          <center><button id="snd" type="submit">Upload Certificate</button></center>
                                      </div>
                                  </form>
                              </div>
                              </center>
